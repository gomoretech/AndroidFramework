...
import com.gomore.gomorelibrary.view.pickerview.listener.OnDismissListener;
import com.gomore.gomorelibrary.view.pickerview.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    public void dismiss(boolean isConfirmCancelable) {
        if (isDialog()) {
            dismissDialog(isConfirmCancelable);
        } else {
            if (dismissing) {
                return;
            }
    ...
    public void dismissDialog(boolean isConfirmCancelable) {
        if (mDialog != null) {
