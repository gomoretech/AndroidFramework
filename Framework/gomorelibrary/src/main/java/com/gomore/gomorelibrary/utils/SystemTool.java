...
public class SystemTool {
    ...
    public static boolean checkOnlyWifi(Context context) {
        if (PreferenceHelper.readBoolean(context,
                GomoreConfig.SETTING_FILE, GomoreConfig.ONLY_WIFI)) {
    ...
    public static String getAppVersion(Context context) {
        ...
        try {
            ...
            throw new GomoreException(SystemTool.class.getName()
    ...
    public static String getSign(Context context, String pkgName) {
        try {
            ...
            throw new GomoreException(SystemTool.class.getName() + "the "
