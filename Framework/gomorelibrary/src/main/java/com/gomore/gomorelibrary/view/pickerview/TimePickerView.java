...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private boolean isConfirmCancelable;//点击确定后是否直接隐藏对话框
    ...
    public TimePickerView(Builder builder) {
        ...
        this.isConfirmCancelable = builder.isConfirmCancelable;
    ...
    public static class Builder {
        ...
        private boolean isConfirmCancelable = true;//点击确定后是否直接隐藏对话框
        ...
        public Builder setConfirmCancelable(boolean isConfirmCancelable) {
