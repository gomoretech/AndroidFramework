package com.gomore.gomorelibrary.view.pickerview.lib;
...
import com.gomore.gomorelibrary.view.pickerview.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    WheelTime.OnWheelViewSlideListener onWheelViewSlideListener;
    ...
    public final void setOnWheelViewSlideListener(WheelTime.OnWheelViewSlideListener onWheelViewSlideListener) {
        this.onWheelViewSlideListener = onWheelViewSlideListener;
    }
    ...
    protected final void onItemSelected() {
        ...
        if (onWheelViewSlideListener != null) {
            onWheelViewSlideListener.onWheelViewSlide();
        }
    }
