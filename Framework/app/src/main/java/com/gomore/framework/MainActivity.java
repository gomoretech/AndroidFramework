...
import com.gomore.framework.bean.CardBean;
import com.gomore.framework.bean.ProvinceBean;
import com.gomore.framework.pickerview.FragmentTestActivity;
import com.gomore.framework.pickerview.JsonDataActivity;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.TimePickerUtils).setOnClickListener(this);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_Time && pvTime != null) {
           ...
           /* pvTime.show(); //show timePicker*/
        ...
        } else if (v.getId() == R.id.TimePickerUtils) {//自定义基类
            ...
            endDate.set(endDate.get(Calendar.YEAR), endDate.get(Calendar.MONTH) + 3, endDate.get(Calendar.DAY_OF_MONTH));

            boolean[] type = new boolean[]{true, true, true, true, true, true};
            TimePickerUtils.setTimeCancelable(this, type, "基类使用时间选择", selectedDate, startDate,
                    endDate, DateUtil.pattern1, new TimePickerUtils.TimeSelectListener() {
                        @Override
                        ...
                        @Override
                        public void selectDateString(String date) {
